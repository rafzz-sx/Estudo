...
('EPCAR', 'Matemática', 'Geometria Plana', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 18, '18', NULL, 'facil', 'Um pai comprou um terreno retangular e repartiu-o em quatro terrenos também retangulares entre seus quatro filhos, conforme o croqui abaixo.
...
('EPCAR', 'Matemática', 'Potenciação e Radiciação', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 19, '19', NULL, 'medio', NULL, 'Considerando os números A = √(23 - 8√7) e B = 64 - 56√7
...
('EPCAR', 'Matemática', 'Conjuntos Numéricos', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 20, '20', NULL, 'facil', 'Na matemática, define-se módulo de um número como a distância que esse número está do zero na reta numérica.
...
('EPCAR', 'Matemática', 'Função Quadrática', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 21, '21', NULL, 'dificil', 'Um artista plástico fez um passeio por cidades históricas de Minas Gerais. Ele ficou encantado com as janelas das casas do período colonial.
...
('EPCAR', 'Matemática', 'Análise de Gráficos e Tabelas', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 23, '23', NULL, 'facil', 'Considere o quadro de medalhas abaixo, que reúne cinco países do continente americano com melhor colocação no quadro de medalhas dos Jogos Olímpicos de Paris:
...
('EPCAR', 'Matemática', 'Álgebra', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 24, '24', NULL, 'medio', 'Duas cidades Alpha e Beta, estão implementando estratégias para recuperar áreas desmatadas:
...
('EPCAR', 'Matemática', 'Geometria Plana', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 25, '25', NULL, 'medio', 'O espaço interno de uma casa está representado na figura abaixo com as denominações de cada um dos 10 cômodos retangulares na legenda.
...
('EPCAR', 'Matemática', 'Geometria Plana', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 26, '26', NULL, 'facil', NULL, 'Um aluno, "brincando" com seu material de desenho geométrico, régua, compasso, esquadro e transferidor, decidiu desenhar um semicírculo de centro O e raio r cm. Ele considerou o diâmetro PQ como "base" do seu semicírculo.
...
('EPCAR', 'Matemática', 'Aritmética', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 27, '27', NULL, 'facil', NULL, 'Seja n o número 2¹⁸ - 32 sabendo que o número 2¹³ - 1 é primo.
...
('EPCAR', 'Matemática', 'Análise Combinatória', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 28, '28', NULL, 'medio', 'O mestre de matemática da Escola Preparatória de Cadetes do Ar (EPCAR), em uma aula, pediu, na turma alpha, para os alunos formarem duplas.
...
('EPCAR', 'Matemática', 'Funções', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 29, '29', NULL, 'medio', 'No nosso cotidiano, podemos utilizar vários símbolos para facilitar a representação em diversas situações.
...
('EPCAR', 'Matemática', 'Geometria Plana', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 30, '30', NULL, 'medio', 'Considere um triângulo ABC inscrito em uma circunferência de centro O, raio r cm e que possui um segmento de reta que parte do vértice A, passa por O e intercepta o lado BC em P.
...
('EPCAR', 'Português', 'Interpretação de Texto', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 33, '33', NULL, 'medio', 'TEXTO I - Nasa defende teoria de Stephen Hawking sobre o "fim do mundo"; entenda
...
('EPCAR', 'Português', 'Sintaxe', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 36, '36', NULL, 'medio', 'Leia o trecho abaixo.
...
('EPCAR', 'Português', 'Interpretação de Texto', 2026, NULL, 'EPCAR / Comando da Aeronáutica', 45, '45', NULL, 'facil', 'TEXTO IV - O ano passado (Erasmo Carlos / Roberto Carlos)
