...
('ENEM', 'Português', 'Ortografia', 2021, '1º dia', 'INEP', 34, '34', 'linguagens', 'facil', '[DESCRIÇÃO DA IMAGEM: Infográfico intitulado "Os riscos para crianças do uso do celular antes de dormir", mostrando os hormônios afetados (melatonina, leptina, cortisol) e orientações sobre o que fazer.]
...
('ENEM', 'Ciências Humanas', 'Hidrografia', 2021, '1º dia', 'INEP', 81, '81', NULL, 'medio', 'Manifesto dos Pioneiros da Educação Nova (1932)
...
('ENEM', 'Ciências da Natureza', 'Ondulatória', 2021, '2º dia', 'INEP', 16, '106', NULL, 'medio', 'A icterícia, popularmente conhecida por amarelão, é uma patologia frequente em recém-nascidos. Na presença de luz, a bilirrubina é convertida no seu isômero lumirrubina que, por ser mais solúvel em água, é excretada pela bile ou pela urina.
...
('ENEM', 'Ciências da Natureza', 'Ondulatória', 2021, '2º dia', 'INEP', 28, '118', NULL, 'medio', 'A curcumina, uma das substâncias que confere a cor alaranjada ao açafrão, pode auxiliar no combate à dengue quando adicionada à água de criadouros do mosquito transmissor. Essa substância acumula-se no intestino do inseto e induz a produção de espécies reativas de oxigênio quando ativada pela luz.
...
('ENEM', 'Sociologia', 'Teóricos Clássicos', 2022, '1º dia', 'INEP', 60, 'Questão 60', 'humanas', 'medio', 'Um experimento denominado FunFit foi desenvolvido
...
('ENEM', 'Geografia', 'Hidrografia', 2022, '1º dia', 'INEP', 82, 'Questão 82', 'humanas', 'medio', 'Rochas ígneas
Amazônia Legal
...
('ENEM', 'Filosofia', 'Ética e Moral', 2022, '1º dia', 'INEP', 84, 'Questão 84', 'humanas', 'medio', 'TEXTO I
...
('ENEM', 'Química', 'Química Orgânica', 2022, '2º dia', 'INEP', 121, 'Questão 121', 'natureza', 'medio', 'Antimicrobianos	são	substâncias	naturais	ou	sintéticas	que	têm	capacidade	de	matar	ou	inibir	o	crescimento	de
...
('ENEM', 'Artes', 'Teatro e Dança', 2023, '1º dia', 'INEP', 39, '39', 'linguagens', 'facil', 'A petição on-line criada por um cidadão paulista surtiu efeito: casado há três anos com seu companheiro, ele pedia a alteração da definição de "casamento" no tradicional dicionário Michaelis em português. Na definição anterior, casamento aparecia como "união legítima entre homem e mulher" e "união legal entre homem e mulher, para constituir família".
