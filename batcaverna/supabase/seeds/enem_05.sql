...
('ENEM', 'Química', 'Eletroquímica', 2025, '2º dia', NULL, 124, NULL, 'natureza', 'medio', 'Objetos de prata escurecem em contato com compostos contendo enxofre por causa da formação de uma fina camada de sulfeto de prata. Um método simples para clarear o objeto consiste em forrar um recipiente com papel alumínio, adicionar ao recipiente uma solução aquosa de cloreto de sódio e, enfim, mergulhar o objeto de prata enegrecido. Em cerca de três minutos, a prata volta à coloração original.
...
('ENEM', 'Física', 'Termologia e Calorimetria', 2025, '2º dia', NULL, 128, NULL, 'natureza', 'medio', 'Para um sensor feito de platina, a relação entre a resistência e a temperatura pode ser descrita por uma equação do tipo R(T) = A + B.T, em que T é a temperatura e A e B são constantes. O gráfico apresenta a dependência da resistência em função da temperatura para cinco diferentes sensores (Sensor 1 ao Sensor 5).
...
('ENEM', 'Biologia', 'Microbiologia e Doenças', 2025, '2º dia', NULL, 129, NULL, 'natureza', 'medio', 'O ácido úsnico é retirado de liquens e foi testado contra diversas espécies:
...
('ENEM', 'Física', 'Eletrodinâmica', 2025, '2º dia', NULL, 130, NULL, 'natureza', 'medio', 'Considere um equipamento de resistência elétrica Rc que funciona corretamente apenas em um dado valor de tensão. Porém, a única fonte de alimentação disponível fornece uma tensão 20% superior à tensão recomendada. Para adaptar essa fonte ao aparelho, a associação de um resistor de proteção Rp se faz necessária.
...
('ENEM', 'Química', 'Estequiometria', 2025, '2º dia', NULL, 131, NULL, 'natureza', 'medio', 'O processo utilizado na produção do nióbio (massa molar 93 g/mol) é a redução aluminotérmica de Nb2O5 com excesso de 10% de Al (massa molar 27 g/mol), em relação à quantidade estequiométrica:
...
('ENEM', 'Física', 'Ondulatória', 2025, '2º dia', NULL, 132, NULL, 'natureza', 'medio', 'O nível sonoro, em decibel (dB), é calculado pela expressão n = 10 log10(I / I0).
...
('ENEM', 'Química', 'Química Orgânica', 2025, '2º dia', NULL, 133, NULL, 'natureza', 'medio', 'Pesquisadores desenvolveram um filtro capaz de separar óleo e água. O dispositivo é montado sobre uma malha de aço com uma sequência de camadas:
...
('ENEM', 'Química', 'Química Orgânica', 2025, '2º dia', NULL, 134, NULL, 'natureza', 'medio', 'Alguns hormônios sexuais apresentam baixa polaridade e solubilidade pequena e variável em água. As estruturas apresentadas são:
...
('ENEM', 'Física', 'Ondulatória', 2025, '2º dia', NULL, 135, NULL, 'natureza', 'medio', 'No tratamento de fototerapia com LEDs azuis, utiliza-se um sensor com fotoluminescência que altera sua emissão de vermelho-laranja (~600 nm) para verde com o tempo. A frequência da luz emitida pelo sensor AUMENTA em função do tempo de exposição.
...
('ENEM', 'Matemática', 'Probabilidade', 2025, '2º dia', NULL, 137, NULL, 'matematica', 'medio', 'Segundo dados de uma reportagem:
...
('ENEM', 'Matemática', 'Geometria Espacial', 2025, '2º dia', NULL, 138, NULL, 'matematica', 'medio', 'Um cubo posicionado em um sistema cartesiano 3D aproxima-se 3 unidades do plano yz, afasta-se 5 unidades do plano xz e aproxima-se 4 unidades do plano xy.
...
('ENEM', 'Matemática', 'Estatística', 2025, '2º dia', NULL, 142, NULL, 'matematica', 'medio', 'A velocidade de referência de conexões de internet em dez cidades (em MB/s) é:
...
('ENEM', 'Matemática', 'Aritmética', 2025, '2º dia', NULL, 143, NULL, 'matematica', 'medio', 'Informações de sódio por pacote de cinco alimentos:
...
('ENEM', 'Matemática', 'Geometria Espacial', 2025, '2º dia', NULL, 144, NULL, 'matematica', 'medio', 'Um protótipo de peça tem a forma de um poliedro convexo obtido pela junção de um prisma hexagonal regular reto com um tronco de pirâmide hexagonal reta (com a base maior do tronco coincidindo com a base do prisma).
...
('ENEM', 'Matemática', 'Funções', 2025, '2º dia', NULL, 145, NULL, 'matematica', 'medio', 'O gráfico apresenta a relação da frequência respiratória (rpm) em relação ao tempo t de um praticante de meditação: no instante t1 inicia-se a prática meditativa, e a frequência reduz progressivamente até o instante t2, a partir do qual se estabiliza no valor f2.
...
('ENEM', 'Matemática', 'Aritmética', 2025, '2º dia', NULL, 146, NULL, 'matematica', 'medio', 'Marca de referência nos 100 metros rasos: 10,00 segundos. Recorde mundial de Usain Bolt em 2009: 9,58 segundos.
...
('ENEM', 'Matemática', 'Estatística', 2025, '2º dia', NULL, 147, NULL, 'matematica', 'medio', 'Matrículas por idioma em 2024: Inglês (280), Espanhol (80), Francês (20), Alemão (20).
...
('ENEM', 'Matemática', 'Razão, Proporção e Regra de Três', 2025, '2º dia', NULL, 148, NULL, 'matematica', 'medio', 'Deslocamentos exibidos na tela do controle remoto:
...
('ENEM', 'Matemática', 'Geometria Espacial', 2025, '2º dia', NULL, 149, NULL, 'matematica', 'medio', 'A cúpula pentagonal giralongada possui como faces: 1 decágono regular, 1 pentágono regular, 5 quadrados e 15 triângulos equiláteros.
...
('ENEM', 'Matemática', 'Razão, Proporção e Regra de Três', 2025, '2º dia', NULL, 150, NULL, 'matematica', 'medio', 'Uma fábrica com 3 funcionários, trabalhando 6 horas diárias, produz 720 tijolos por dia. A fábrica passou a ter 5 funcionários, trabalhando 9 horas diárias.
...
('ENEM', 'Matemática', 'Raciocínio Lógico', 2025, '2º dia', NULL, 151, NULL, 'matematica', 'medio', 'Código de identificação de 7 dígitos:
...
('ENEM', 'Matemática', 'Análise Combinatória', 2025, '2º dia', NULL, 152, NULL, 'matematica', 'medio', 'Os celulares de quatro candidatos foram recolhidos e guardados em quatro envelopes pretos sem identificação. Ao término da prova, o aplicador devolveu aleatoriamente um envelope a cada candidato.
...
('ENEM', 'Matemática', 'Geometria Analítica', 2025, '2º dia', NULL, 153, NULL, 'matematica', 'medio', 'No plano cartesiano, os vértices de um quadrado STUV contêm o herói na posição inicial S(6, 2) e dois vilões nas posições V(8, 6) e T(2, 4). O herói movimenta-se na trajetória equidistante dos vilões V e T.
...
('ENEM', 'Matemática', 'Análise Combinatória', 2025, '2º dia', NULL, 155, NULL, 'matematica', 'medio', 'Dez casais constituirão uma diretoria com três cargos: presidente, secretário e tesoureiro. No máximo uma pessoa por casal pode ocupar um cargo nessa diretoria.
...
('ENEM', 'Matemática', 'Razão, Proporção e Regra de Três', 2025, '2º dia', NULL, 156, NULL, 'matematica', 'medio', 'Um esboço feito na areia medindo 20 cm foi ampliado mantendo as mesmas proporções para uma obra com dimensão de 30 m.
...
('ENEM', 'Matemática', 'Razão, Proporção e Regra de Três', 2025, '2º dia', NULL, 157, NULL, 'matematica', 'medio', 'Em um estudo, a concentração de cortisol salivar no dia de trabalho (T) era, em média, 1,59 vezes a concentração no dia de folga (F).
...
('ENEM', 'Matemática', 'Geometria Espacial', 2025, '2º dia', NULL, 159, NULL, 'matematica', 'medio', 'O dono de uma sorveteria armazena sorvete em potes de 20 000 cm³. Ele serve o sorvete em taças em porções de 250 mL.
...
('ENEM', 'Matemática', 'Trigonometria', 2025, '2º dia', NULL, 160, NULL, 'matematica', 'medio', 'A distância D da lâmina de água ao tampo da mesa varia com o tempo T (de 0 a 4 min) segundo D = k + tg[p(T + m)].
...
('ENEM', 'Matemática', 'Equações e Inequações', 2025, '2º dia', NULL, 162, NULL, 'matematica', 'medio', 'Uma empresa produz 110 toneladas de plástico de petróleo e 80 toneladas de plástico reciclado por mês. Custo de reciclagem = R$ 500,00/t (que equivale a 5% do custo do plástico de petróleo, ou seja, petróleo custa R$ 10 000,00/t). Para o próximo mês, a meta é produzir a mesma quantidade total (190 t) com redução de pelo menos 50% no custo total de produção.
...
('ENEM', 'Matemática', 'Estatística', 2025, '2º dia', NULL, 163, NULL, 'matematica', 'medio', 'Todos os estudantes do ensino médio praticam apenas um esporte (Futebol, Vôlei ou Basquete).
...
('ENEM', 'Matemática', 'Trigonometria', 2025, '2º dia', NULL, 164, NULL, 'matematica', 'medio', 'Rota planejada: P -> Q (direção 110°, 4h), Q -> R (direção 90°, 2h).
...
('ENEM', 'Matemática', 'Estatística', 2025, '2º dia', NULL, 165, NULL, 'matematica', 'medio', '55 mulheres foram distribuídas em 5 grupos de 11 pessoas. O grupo escolhido deve apresentar a maioria das mulheres (pelo menos 6 de 11) com idades entre 20 e 30 anos.
...
('ENEM', 'Matemática', 'Aritmética', 2025, '2º dia', NULL, 166, NULL, 'matematica', 'medio', 'Em uma corrida de 5 km, o corredor acumulou os tempos ao cruzar as marcas: 1 km (272 s), 2 km (556 s), 3 km (844 s), 4 km (1 132 s). O tempo no 4º trecho foi de 288 s.
...
('ENEM', 'Matemática', 'Análise de Gráficos e Tabelas', 2025, '2º dia', NULL, 167, NULL, 'matematica', 'medio', 'Em uma viagem de 240 km mantendo velocidade constante de 60 km/h:
...
('ENEM', 'Matemática', 'Aritmética', 2025, '2º dia', NULL, 168, NULL, 'matematica', 'medio', 'Produtos: 20 aulas teóricas + 10 aulas práticas + aluguel do veículo.
Tabela de preços:
...
('ENEM', 'Matemática', 'Estatística', 2025, '2º dia', NULL, 169, NULL, 'matematica', 'medio', 'Produtividade de soja (sacas de 50 kg por hectare) e área cultivada (hectare):
...
('ENEM', 'Matemática', 'Geometria Espacial', 2025, '2º dia', NULL, 171, NULL, 'matematica', 'medio', 'Tortas cilíndricas possuem raio da base entre 12 cm e 16 cm (diâmetro máximo de 32 cm). Serão embaladas em caixas prismáticas de base quadrada, restando pelo menos 1 cm de folga entre a torta e as superfícies internas. As caixas originais possuem base quadrada de 14 cm de lado.
...
('ENEM', 'Matemática', 'Logaritmos e Exponenciais', 2025, '2º dia', NULL, 172, NULL, 'matematica', 'medio', 'Pressão interna de uma máquina: P = 4. log[-K. (t + 1). (t - 19)], onde t é o tempo contínuo de uso em horas.
...
('ENEM', 'Matemática', 'Geometria Plana', 2025, '2º dia', NULL, 173, NULL, 'matematica', 'medio', 'Projeto 1: Dois túneis semicilíndricos independentes, um de diâmetro 12 m (automóveis) e outro de diâmetro 6 m (bicicletas).
...
('ENEM', 'Matemática', 'Equações e Inequações', 2025, '2º dia', NULL, 174, NULL, 'matematica', 'medio', 'Um carro custa R$ 60 mil e possui duas opções de pagamento sem juros:
...
('ENEM', 'Matemática', 'Análise Combinatória', 2025, '2º dia', NULL, 175, NULL, 'matematica', 'medio', 'Um pai distribuirá 8 presentes distintos (incluindo 1 bicicleta e 1 celular) para 3 filhos. O mais velho receberá 3 presentes, o mais novo 3 presentes, e o do meio 2 presentes. O filho mais velho ganhará obrigatoriamente a bicicleta ou o celular, mas não ambos.
...
('ENEM', 'Matemática', 'Razão, Proporção e Regra de Três', 2025, '2º dia', NULL, 176, NULL, 'matematica', 'medio', 'Um jogador entrou no início do segundo tempo regulamentar (45 minutos) e percorreu 4,5 km. Na prorrogação (30 minutos), manteve a mesma velocidade média do segundo tempo.
...
('ENEM', 'Matemática', 'Probabilidade', 2025, '2º dia', NULL, 178, NULL, 'matematica', 'medio', 'Artur lança dois dados cúbicos comuns e João lança o terceiro dado. Compara-se o maior número obtido por Artur com o número de João. Vence quem obtiver o maior número; em caso de empate, João vence.
...
('ENEM', 'Matemática', 'Grandezas e Medidas', 2025, '2º dia', NULL, 179, NULL, 'matematica', 'medio', 'A luminância é definida como a razão entre a intensidade luminosa, medida em candela (cd), e o quadrado da distância do objeto até o foco de luz, medida em metro (m).
...
('ENEM', 'Matemática', 'Sequências e Recorrências', 2025, '2º dia', NULL, 180, NULL, 'matematica', 'medio', 'Quatro jogadores (1, 2, 3 e 4) iniciam com 100 moedas cada. A cada rodada:
